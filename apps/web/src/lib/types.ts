...
export type InventoryProcurementOrder = components["schemas"]["InventoryProcurementOrder"];
...
export type ReceiveProcurementOrderRequest = components["schemas"]["ReceiveProcurementOrderRequest"];
