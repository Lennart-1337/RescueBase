...
export const rescueBaseApi = {
  ...
  emailChangePreview: (token: string) => openApiClient.get("/auth/email-changes/{token}", { params: { token } }),
  confirmEmailChange: (token: string) => openApiClient.post("/auth/email-changes/{token}/confirm", { params: { token } }),
  ...
  updateUserProfile: (id: string, body: UpdateUserProfileRequest) => openApiClient.post("/auth/users/{id}/profile", body, { params: { id } }),
  resendUserInvitation: (id: string) => openApiClient.post("/auth/users/{id}/invitation/resend", { params: { id } }),
  revokeUserInvitation: (id: string) => openApiClient.delete("/auth/users/{id}/invitation", { params: { id } }),
  sendUserPasswordReset: (id: string) => openApiClient.post("/auth/users/{id}/password-reset", { params: { id } }),
