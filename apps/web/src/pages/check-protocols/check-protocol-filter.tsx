...
export function CheckProtocolFilter(props: { count: number; filters: CheckProtocolFilters; kits: Kit[]; onChange: (patch: Partial<CheckProtocolFilters>) => void; onReset: () => void; totalCount: number }) {
  const statusOptions = [
  ...
  return (
    <ListFilterBar countLabel={`${props.count}/${props.totalCount} sichtbar`} fieldsClassName="form-grid-three" onReset={props.onReset}>
