...
import { createMedicalDevice, deleteMedicalDevice, listMedicalDevices, updateMedicalDevice } from "../../lib/extra-api";
...
export function MasterDataDevicePage({ filters }: { filters: DeviceFilters }) {
  ...
  const deleteDevice = useMutation({ mutationFn: deleteMedicalDevice, onSuccess: async () => queryClient.invalidateQueries({ queryKey: ["medical-devices"] }) });
