...
import { AccountPushNotificationsPanel } from "./account/account-push-notifications-panel";
...
export function AccountPage({ user }: { user: AuthenticatedUser }) {
  return (
    <>
      ...
      <PageSection title="Benachrichtigungen"><AccountAlertsPanel /><div className="admin-grid account-notification-grid"><AccountOrderNotificationsPanel user={user} /><AccountPushNotificationsPanel /></div></PageSection>
    </>
  );
}
