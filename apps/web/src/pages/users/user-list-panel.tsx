...
export function UserListPanel(props: { currentUserId: string; error: Error | null; isSubmitting: boolean; onDelete: (id: string) => void; onEditProfile: (entry: UserSummary) => void; onResendInvitation: (entry: UserSummary) => void; onRevokeInvitation: (entry: UserSummary) => void; onSecurity: (entry: UserSummary) => void; onToggle: (id: string, active: boolean) => void; users: UserSummary[] }) {
