...
export function BatchListPanel(props: { batches: Batch[]; error: Error | null; isSubmitting: boolean; onCreate: () => void; onDelete: (id: string) => void; onSelect: (id: string) => void; selectedBatchId: string | null }) {
