...
export function InventoryPage() {
  ...
  return (
    <>
      ...
      <BatchListPanel batches={batches.data} error={deleteMutation.error ? toError(deleteMutation.error) : null} isSubmitting={deleteMutation.isPending} onCreate={() => setCreateOpen(true)} onDelete={(id) => deleteMutation.mutate(id)} onSelect={(id) => { setSelectedBatchId(id); setCorrectionOpen(true); }} selectedBatchId={selectedBatchId} />
