...
BETTER_AUTH_SECRET="$(require_env_value BETTER_AUTH_SECRET)"
...
export API_IMAGE WEB_IMAGE IMAGE_TAG MARIADB_DATABASE MARIADB_USER MARIADB_PASSWORD APP_PUBLIC_URL JWT_SECRET BETTER_AUTH_SECRET RESEND_API_KEY RESEND_FROM CLOUDFLARE_ORIGIN_CERT_HOST_FILE CLOUDFLARE_ORIGIN_KEY_HOST_FILE
